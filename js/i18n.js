const I18N = {
  en: {
    ...
    project: {
      ...
      prototype: "Playable prototype of the core loop. Press Play to open it in a phone frame.",
      embed: "Full WebGL build. Press Play to open it in a phone frame — the engine loads then.",
    },
    play: {
      start: "Play",
      restart: "Play again",
      ...
      win: "You win",
      lose: "Game over",
      touch: "Drag on the screen to move, tap to attack. Keyboard still works.",
  ...
  ru: {
    ...
    project: {
      ...
      prototype: "Игровой прототип основного цикла. Нажмите «Играть» — откроется в рамке телефона.",
      embed: "Полная WebGL-сборка. Нажмите «Играть» — игра откроется в рамке телефона, движок подгрузится после этого.",
    },
    play: {
      start: "Играть",
      restart: "Ещё раз",
      ...
      win: "Победа",
      lose: "Поражение",
      touch: "На экране: перетаскивание — движение, тап — удар. Клавиатура тоже работает.",
